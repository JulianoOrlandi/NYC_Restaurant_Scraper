...
# Preparing the parameters for the API request
...
# Loop through the quadrants to perform the search using the process_quadrant function
...
# Save the results to a JSON file after completing the search
save_results_to_json(all_places)

# Save the results to a CSV file after completing the search
#save_results_to_csv(all_places)
